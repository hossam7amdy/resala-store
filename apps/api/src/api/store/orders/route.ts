...
import { localizeOrders, withTranslationFields } from './helpers'
...
export const GET = async (
  ...
  const localizedOrders = localizeOrders(
    rows as unknown as HttpTypes.StoreOrder[],
    req.context?.locale
  )

  res.json({
    orders: localizedOrders as unknown as HttpTypes.StoreOrder[],
