...
import { languages, type StaticLanguage } from '../../../../lib/data/languages'
import { useCreateStoreLocale, useStore } from '../../../../hooks/api'
...
export const LocaleCreateForm = () => {
  ...
  const createStoreLocale = useCreateStoreLocale()
  ...
  const handleSubmit = form.handleSubmit(async (values) => {
    await createStoreLocale.mutateAsync(
      {
        ...values,
        ...
        <RouteFocusModal.Footer>
          <div className="flex items-center justify-end gap-x-2">
            ...
            <Button
              size="small"
              type="submit"
              isLoading={createStoreLocale.isPending}
            >
              {t('actions.save', 'Save')}
            </Button>
          </div>
